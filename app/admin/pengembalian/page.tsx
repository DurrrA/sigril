                                      ...
                                      <div className="flex justify-center items-center gap-1 ">
                                        ...
                                        <AlertDialog>
                                          <AlertDialogTrigger asChild>
                                            <Button variant="default" size="sm" className="text-white bg-blue-500 hover:bg-blue-600" onClick={(e) => e.stopPropagation()}>Konfirmasi</Button>
                                          </AlertDialogTrigger>
                                          <AlertDialogContent>
                                            <AlertDialogHeader>
                                            ...
                                            <AlertDialogFooter>
                                              ...
                                              <AlertDialogAction className="bg-blue-500 hover:bg-blue-600 ">Ya, Konfirmasi</AlertDialogAction>
                                            </AlertDialogFooter>
                                          </AlertDialogContent>
                                        </AlertDialog>
                                        
                                        <Button variant="default" size="sm" className="text-white bg-green-700 hover:bg-green-800" onClick={(e) => e.stopPropagation()}>Siap Sewa</Button>
